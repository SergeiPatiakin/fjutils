...
class Subl3Config(BaseConfig):
    ...
    def get_config_files():
        ...
        if platform == "windows":
            ...
            yours_path = os.path.join(app_data_root, 'Sublime Text 3', "Packages", "User", "Preferences.sublime-settings")
        else:
            yours_path = homepath(".config", "sublime-text-3", "Packages","User", "Preferences.sublime-settings")
